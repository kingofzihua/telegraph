...
```
go get github.com/go-ostrich/pkg/shutdown
```

## Documentation

`github.com/go-ostrich/pkg/shutdown` documentation is available on [godoc](http://godoc.org/github.com/go-ostrich/pkg/shutdown).

Both `ShutdownManagers` are also documented:
- [`PosixSignalManager`](http://godoc.org/github.com/go-ostrich/pkg/shutdown/shutdownmanagers/posixsignal)
- [`AwsManager`](http://godoc.org/github.com/go-ostrich/pkg/shutdown/shutdownmanagers/awsmanager)
...
import (
	...
	"github.com/go-ostrich/pkg/shutdown/shutdownmanagers/awsmanager"
